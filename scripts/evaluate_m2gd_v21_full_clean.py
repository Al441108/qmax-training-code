#!/usr/bin/env python3
"""Full held-out clean-PD evaluation for a selected M2-GD v2.1 model.
...
from evaluate_m2gd_v21_smoke_audit import (  # noqa: E402
    IndexedDataset,
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description=(
            ...
            "Stage B on every clean held-out validation slice."
        )
    )
