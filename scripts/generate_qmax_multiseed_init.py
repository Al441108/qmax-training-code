...
"""Generate and audit QMax-Full replication initialisations."""
...
ALLOWED_REPLICATION_SEEDS = (123, 2026)
...
def main() -> None:
    ...
    if args.seed not in ALLOWED_REPLICATION_SEEDS:
        raise ValueError(
            "Replication template seed must be one of "
