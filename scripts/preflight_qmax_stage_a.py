...
"""Strict real-batch GPU preflight for QMax-Core and QMax-Full."""
...
def main() -> None:
    ...
    if args.seed != 42 or args.formal_batch_size != 4:
        raise ValueError("Frozen preflight requires seed=42 and batch=4")
    if not args.amp:
    ...
    result = {
        ...
        "protocol_version": (
            "QMax-StageA-preflight-v6-dc-connectivity"
        ),
        "device": str(device),
