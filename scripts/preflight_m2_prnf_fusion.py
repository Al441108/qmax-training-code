...
"""Preflight for strict M2-U compatibility and v1.4 pilot trainability."""
...
def main():
    ...
    first_loss = reconstruction_loss + 0.05 * reliability_loss
    first_loss.backward()
    first_gradients = [
    ...
    del prediction, aux, reconstruction_loss, reliability_loss, first_loss
    prediction, aux = hybrid(
        paired_kspace, paired_mask, paired_pd, availability, return_aux=True
    )
    ...
    second_loss = reconstruction_loss + 0.05 * reliability_loss
