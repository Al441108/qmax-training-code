#!/usr/bin/env python3
"""Formal 25-patient robustness confirmation for a selected model.
...
from scripts.evaluate_m2gd_v21_smoke_audit import (
    IndexedDataset,
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Formal 25-patient M2-GD v2.1 robustness confirmation."
    )
    ...
    parser.add_argument("--acceleration", type=int, required=True, choices=[4, 6, 8])
    parser.add_argument(
    ...
    assert_checkpoint_identity(
        m2u_identity,
        args.expected_m2u_epoch,
        args.acceleration,
        args.pd_aux_acceleration,
    )
    assert_checkpoint_identity(
        m2gd_v2_identity,
        args.expected_m2gd_v2_epoch,
        args.acceleration,
        args.pd_aux_acceleration,
        "smoke5",
    )
    ...
    manifest = {
        "protocol": (
            f"M2-GD v2.1 formal robustness R{args.acceleration} revision 1"
        ),
        "pdfs_acceleration": args.acceleration,
        "pd_aux_acceleration": args.pd_aux_acceleration,
