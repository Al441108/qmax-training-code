...
def main():
    parser = argparse.ArgumentParser(
        description="B1 Auxiliary PD-assisted PD-FS VarNet training."
    )

    parser.add_argument("--metadata_csv", required=True)
    parser.add_argument("--acceleration", type=int, choices=[4, 6, 8, 12], required=True)
    ...
    print("Auxiliary input: full/high-quality PD target image")
    print("=" * 80)
