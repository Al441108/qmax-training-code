...
def main():
    parser = argparse.ArgumentParser(
        description="M1-revised jVN-style joint PD/PD-FS VarNet training."
    )
    ...
    print("=" * 80)
    print("Complementary-mask revised joint experiment")
    print(f"PD mask type: {args.pd_mask_type}")
    print(f"PD-FS mask type: {args.pdfs_mask_type}")
    print(f"Acceleration R: {args.acceleration}")
    print("=" * 80)
    ...
    config.update(
        {
            ...
            "model": "M1-revised JointVarNet: independent DC + jVN-style 4-channel regulariser",
